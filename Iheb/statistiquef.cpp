#include "statistiquef.h"
#include "ui_statistiquef.h"
#include <QString>
#include <QSqlQuery>
#include <QSqlQueryModel>
#include <QDialog>

statistiquef::statistiquef(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::statistiquef)
{
    ui->setupUi(this);
    ...
    QSqlQuery query,query1,query2;
        ...
        nuclear->moveAbove(fossil);
          ...
          while(query.next())
          {
           ...
           query1.prepare("SELECT count(*) FROM produit where id_four = '"+query.value(0).toString()+"' ");
           query1.exec();
           while (query1.next()) {
